  ...
  public function postRemind() {
    ...
    if ($validator->passes()) {
      ...
      switch ($response = Password::remind(Input::only('email'), function($message) {
        ...
        LoggerHelper::log('AUTH', Lang::get('logs.msg.password.remind', ['email' => Input::get('email')]));
  ...
  public function postReset() {
    ...
    if ($validator->passes()) {
      ...
      $response = Password::reset($credentials, function($user, $password) {
        ...
        LoggerHelper::log('AUTH', Lang::get('logs.msg.password.reset', ['email' => $user->email, 'id' => $user->id]));
      });
