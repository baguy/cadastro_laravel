<div id="modalDelete_{{ $data['atendimento']->id }}" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <ul class="list-group list-group-flush">
          <li class="list-group-item d-flex justify-content-between align-items-center p-1">
            {{ $data['atendimento']->titulo }}
            <span class="badge badge-dark badge-pill">{{ trans('atendimento.lbl.titulo') }}</span>
          </li>
          <li class="list-group-item d-flex justify-content-between align-items-center p-1">
            <span class="text-secondary">{{ $data['atendimento']->created_at }}</span>
      ...
      <div class="modal-footer">
        ...
        {{ Form::model($data['atendimento'], array('method' => 'DELETE', 'route' => array('atendimento.destroy', $data['atendimento']->id))) }}
