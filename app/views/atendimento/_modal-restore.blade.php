<div id="modalRestore_{{ $data['atendimento']->id }}" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        {{ Form::model($data['atendimento'], array('method' => 'PATCH', 'route' => array('atendimento.restore', $data['atendimento']->id))) }}
