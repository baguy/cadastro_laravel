...
<div class="login-box">
  ...
  <div class="login-logo">
    <img class="img-circle elevation-3" src="assets/img/social-service-white.png" alt="logo" style="height:15%; width:15%; background-color:#02302b">
    <b>{{ trans('application.config.name') }}</b>

    <h5><p>{{ trans('application.config.nickname') }}</p></h5>
  </div>
