<div id="modalRestore_{{ $data['entrada']->id }}" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        {{ Form::model($data['entrada'], array('method' => 'PATCH', 'route' => array('entrada.restore', $data['entrada']->id))) }}
