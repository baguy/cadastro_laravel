<div id="modalRestore_{{ $data['funcionario']->id }}" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        {{ Form::model($data['funcionario'], array('method' => 'PATCH', 'route' => array('funcionario.restore', $data['funcionario']->id))) }}
