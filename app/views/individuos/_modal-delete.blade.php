<div id="modalDelete_{{ $individuo->id }}" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        {{ Form::model($individuo, array('method' => 'DELETE', 'route' => array('individuos.destroy', $individuo->id))) }}
          <button type="submit" class="btn btn-danger teste">{{ trans('application.btn.confirm') }}</button>
        {{ Form::close() }}
      </div>
    </div>
  </div>
