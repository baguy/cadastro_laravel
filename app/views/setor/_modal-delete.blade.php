<div id="modalDelete_{{ $data['setor']->id }}" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        {{ Form::model($data['setor'], array('method' => 'DELETE', 'route' => array('setor.destroy', $data['setor']->id))) }}
